...
export function makeHelmetChart(){
  ...
  const columns=[['HELMET',52],['FRONT / BACK',680],['DUR',900],['ZONES',990],['DETAILS',1220],['OBTAIN',1530]];
  let y=162,body='';
